...
extension Movie {
    ...
    static var watchedKey: String {
        return "Watched"
    }
    static var willsKey: String {
        return "wills"
    }
    ...
    func addToWills() {
        // 1.
        var willsMovies = Movie.getMovies(forKey: Movie.willsKey)
        // 2.
        willsMovies.append(self)
        // 3.
        Movie.save(willsMovies, forKey: Movie.willsKey)
    }

    func addToWatched() {
        // 1.
        var watchedMovies = Movie.getMovies(forKey: Movie.watchedKey)
        // 2.
        watchedMovies.append(self)
        // 3.
        Movie.save(watchedMovies, forKey: Movie.watchedKey)
    }
    ...
    func removeFromWills() {
        // 1.
        var willsMovies = Movie.getMovies(forKey: Movie.willsKey)
        // 2.
        willsMovies.removeAll { movie in
            // 3.
            return self == movie
        }
        // 4.
    ...
    func removeFromWatched() {
        // 1.
        var watchedMovies = Movie.getMovies(forKey: Movie.watchedKey)
        // 2.
        watchedMovies.removeAll { movie in
            // 3.
            return self == movie
        }
        // 4.
